...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $route_stmt->bind_param("i", $_POST['route_id']);
        $route_stmt->execute();
        $waktu_tempuh = $route_stmt->get_result()->fetch_assoc()['waktu_tempuh'];
        
        // Convert waktu_tempuh to hours and minutes
        ...
        // Calculate waktu_tiba by adding waktu_tempuh minutes
